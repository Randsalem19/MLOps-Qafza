...
def main() -> None:
    ...
    categorical_pipeline = Pipeline([
        ...
        ("encoder", OneHotEncoder(handle_unknown="infrequent_if_exist", min_frequency=5, sparse_output=True)),
    ])
    ...
    (models_dir / "06_results_summary.json").write_text(
        json.dumps({"selected_threshold": 0.5, "best_C": 1.0, "primary_metric": "PR-AUC", "test_results": []}),
        encoding="utf-8",
    )
